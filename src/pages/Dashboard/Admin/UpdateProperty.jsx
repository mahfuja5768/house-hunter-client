...
if (saveProperty.data.modifiedCount > 0) {
  Swal.fire({
    title: "Success!",
    text: "Property added!",
    icon: "success",
      ...
      <div className="py-8 max-w-[1280px] mx-auto px-4 lg:px-12">
        <div className="lg:col-span-2 ">
          <h1 className=" lg:text-5xl text-center text-4xl font-bold  my-12">
            Welcome to <span className="text-secondary">Update property</span>{" "}
            page,
          </h1>
          <form onSubmit={handleBook} className=" space-y-5 text-black">
            <div className="">
              ...
              <div className="form-control my-5">
                <label>
                  <input defaultValue={availability_date}
                    type="date"
              ...
              <div className="form-control my-5">
                <label>
                  <input defaultValue={rent_per_month}
                    type="number"
                    name="rent_per_month"
